...
public class IfEx17 {
	...
	public static void main(String[] args) {
		...
		if (fianlScore >= 60) { //조건식이 true일때 실행
		...
		if (fianlScore >= 90) { //조건식이 true일때 실행
			System.out.println("A");
		}
		else if (fianlScore >= 80) { // 위 조건식이 false이며 조건식이 true일때 실행
		
			System.out.println("B");
		}
		else if (fianlScore >= 70) {  //위 조건식이 false이며 조건식이 true일때 실행
